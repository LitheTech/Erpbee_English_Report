...
def get_leave_data(filters):
	conditions, filters = get_conditions(filters)
	result= frappe.db.sql("""select la.employee, emp.designation, la.from_date, la.to_date, la.leave_type,
		la.total_leave_days, la.leave_balance-la.total_leave_days
...
def get_conditions(filters):
	...
	if filters.get("employee"): conditions += " and la.employee= '%s'" % filters["employee"]
